...
let isOnline = true, intervalId, timer = 15;
...
const handlePopup = (status) => {
    if(status) { // If the status is true (online), update icon, title, and description accordingly
        ...
        popupDesc.innerHTML = "Your device is now successfully re-connected to the internet.";
    ...
    popupDesc.innerHTML = "Your network is unavailable. We will attempt to reconnect you in <b>15</b> seconds.";
